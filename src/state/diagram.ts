...
import { renderStateGridAnsi, renderStateGridText, type StateCellMetadata, type StateGrid } from "./render-grid.js"
import {
...
export function layoutStateDiagram(content: string, options: StateDiagramRenderOptions = {}): StateGrid {
